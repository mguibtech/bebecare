  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    const seeds: VaccineSeed[] = [
      ...
      },
      {
        code: 'HEPB_BIRTH',
        name: 'Hepatite B',
        description: 'Primeira dose da Hepatite B, aplicada nas primeiras 24h de vida.',
        doseLabel: 'Ao nascer',
        doseNumber: 1,
        isBooster: false,
        recommendedAgeMonths: 0,
      ...
      // ===== 2 MESES =====
      {
        ...
        name: 'Pentavalente',
        description:
          'DTP (difteria, tétano, coqueluche) + Hib (Haemophilus influenzae B) + Hepatite B.',
        doseLabel: '1ª dose',
        doseNumber: 1,
        isBooster: false,
      ...
      },
      {
        ...
        name: 'Rotavírus',
        description:
          'Previne diarreia grave por rotavírus. Janela curta — não pode ser iniciada após 3 meses e 15 dias.',
        doseLabel: '1ª dose',
        doseNumber: 1,
        isBooster: false,
        recommendedAgeMonths: 2,
      ...
      },
      {
        ...
        description: 'Previne pneumonia, meningite e outras doenças pneumocócicas.',
        doseLabel: '1ª dose',
        doseNumber: 1,
        isBooster: false,
        recommendedAgeMonths: 2,
      ...
      // ===== 3 MESES =====
      {
        ...
        description: 'Previne meningite e infecções pelo meningococo C.',
        doseLabel: '1ª dose',
        doseNumber: 1,
        isBooster: false,
      ...
      },
      {
        code: 'VIP_2',
        name: 'Poliomielite (VIP)',
        description: 'Segunda dose da poliomielite inativada.',
        doseLabel: '2ª dose',
        doseNumber: 2,
        isBooster: false,
        recommendedAgeMonths: 4,
      ...
      },
      {
        code: 'ROTA_2',
        name: 'Rotavírus',
        description: 'Segunda dose. Não pode ser aplicada após 7 meses e 29 dias.',
        doseLabel: '2ª dose',
        doseNumber: 2,
        isBooster: false,
        recommendedAgeMonths: 4,
      ...
      // ===== 5 MESES =====
      {
        code: 'MENC_2',
        name: 'Meningocócica C',
        description: 'Segunda dose da meningocócica C.',
        doseLabel: '2ª dose',
        doseNumber: 2,
        isBooster: false,
      ...
      // ===== 6 MESES =====
      {
        code: 'PENTA_3',
        name: 'Pentavalente',
        description: 'Terceira e última dose da pentavalente.',
        doseLabel: '3ª dose',
        doseNumber: 3,
        isBooster: false,
      ...
      },
      {
        code: 'VIP_3',
        name: 'Poliomielite (VIP)',
        description: 'Terceira dose da poliomielite inativada.',
        doseLabel: '3ª dose',
        doseNumber: 3,
        isBooster: false,
        recommendedAgeMonths: 6,
      ...
      // ===== 9 MESES =====
      {
        code: 'YF_1',
        name: 'Febre Amarela',
        description: 'Recomendada para todo o país a partir de 2020.',
        doseLabel: 'Dose inicial',
        doseNumber: 1,
        isBooster: false,
      ...
      // ===== 12 MESES =====
      {
        code: 'MMR_1',
        name: 'Tríplice viral',
        description: 'Sarampo, caxumba e rubéola (SCR).',
        doseLabel: '1ª dose',
        doseNumber: 1,
        isBooster: false,
      ...
      },
      {
        code: 'PCV10_BOOSTER',
        name: 'Pneumocócica 10v',
        description: 'Reforço da pneumocócica.',
        doseLabel: 'Reforço',
        doseNumber: 3,
        isBooster: true,
        recommendedAgeMonths: 12,
      ...
      },
      {
        code: 'MENC_BOOSTER',
        name: 'Meningocócica C',
        description: 'Reforço da meningocócica.',
        doseLabel: 'Reforço',
        doseNumber: 3,
        isBooster: true,
        recommendedAgeMonths: 12,
      ...
      // ===== 15 MESES =====
      {
        code: 'DTP_BOOSTER_1',
        name: 'DTP (reforço)',
        description: 'Primeiro reforço da DTP (difteria, tétano e coqueluche).',
      ...
      },
      {
        ...
        description: 'Reforço oral da poliomielite (gotinha).',
        doseLabel: '1º reforço',
        doseNumber: 4,
        isBooster: true,
        recommendedAgeMonths: 15,
      ...
      },
      {
        code: 'HEPA',
        name: 'Hepatite A',
        description: 'Dose única contra Hepatite A.',
        doseLabel: 'Dose única',
        doseNumber: 1,
        isBooster: false,
        recommendedAgeMonths: 15,
      ...
      },
      {
        ...
        doseLabel: '2ª dose (com varicela)',
        doseNumber: 2,
        isBooster: false,
        recommendedAgeMonths: 15,
        minAgeMonths: 15,
      ...
      // ===== 4 ANOS (48 MESES) =====
      {
        code: 'DTP_BOOSTER_2',
        name: 'DTP (reforço)',
        description: 'Segundo reforço da DTP.',
      ...
      },
      {
        code: 'VOP_BOOSTER_2',
        name: 'Poliomielite (VOP)',
        description: 'Segundo reforço oral da poliomielite.',
        doseLabel: '2º reforço',
        doseNumber: 5,
        isBooster: true,
        recommendedAgeMonths: 48,
      ...
      {
        code: 'VARICELA_BOOSTER',
        name: 'Varicela (reforço)',
        description: 'Reforço da varicela (catapora).',
        doseLabel: 'Reforço',
        doseNumber: 2,
        isBooster: true,
        recommendedAgeMonths: 48,
      ...
      },
      {
        ...
        description: 'Reforço único da febre amarela.',
        doseLabel: 'Reforço',
        doseNumber: 2,
        isBooster: true,
        recommendedAgeMonths: 48,
